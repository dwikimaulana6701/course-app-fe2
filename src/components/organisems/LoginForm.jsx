...
const LoginForm = () => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="bg-[#3ECF4C] hover:bg-green-600 cursor-pointer font-bold text-sm text-white rounded-x tracking-extra-tight py-[7px] px-[22px] mb-4 mt-6 w-full mx-auto flex justify-center lg:py-x lg:text-base">Masuk</button>
            <Link to="/register" className="flex justify-center bg-grin text-center cursor-pointer hover:bg-green-100 rounded-x font-bold text-sm tracking-extra-tight py-[7px] px-[22px] text-[#3ECF4C] lg:py-x lg:text-base">Daftar</Link>
        </form>
    )
}
