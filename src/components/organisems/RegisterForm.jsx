    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className='flex flex-col gap-4'>
                ...
                <div id='gender'>
                    <label className="text-grayCustom font-dmsans tracking-extra-tight text-sm md:font-normal md:text-base md:text-[#4A505C]" htmlFor="jenkel">Jenis Kelamin<span className="text-[#FF5C2B]"> *</span></label>
                ...
                <div id='password'>
                    ...
                    <div className="relative w-full">
                        <input
                            ...
                            required
                        />
                        <button type="button" className="absolute inset-y-0 right-4 flex items-center text-disabled">
                ...
                <div id='forget-pw'>
                    <div className="flex justify-end max-w-full">
                        <a className="text-right font-dmsans font-medium text-sm tracking-extra-tight text-grayCustom hover:underline lg:font-medium lg:text-base lg:text-[#4A505C]" href="">Lupa Password?</a>
                    </div>
                </div>
            </div>

            <button type="submit" className="bg-[#3ECF4C] hover:bg-green-600 cursor-pointer font-bold text-sm text-white rounded-x tracking-extra-tight py-[7px] px-[22px] mb-4 mt-6 w-full mx-auto flex justify-center lg:py-x lg:text-base">Daftar</button>
            <Link to="/login" className="flex justify-center bg-grin text-center cursor-pointer hover:bg-green-100 rounded-x font-bold text-sm tracking-extra-tight py-[7px] px-[22px] text-[#3ECF4C] lg:py-x lg:text-base">Masuk</Link>
        </form>
    )
}
